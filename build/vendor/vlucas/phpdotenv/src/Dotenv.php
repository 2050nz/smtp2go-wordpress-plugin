...
namespace SMTP2GOWPPlugin\Dotenv;

use SMTP2GOWPPlugin\Dotenv\Exception\InvalidPathException;
use SMTP2GOWPPlugin\Dotenv\Loader\Loader;
use SMTP2GOWPPlugin\Dotenv\Loader\LoaderInterface;
use SMTP2GOWPPlugin\Dotenv\Parser\Parser;
use SMTP2GOWPPlugin\Dotenv\Parser\ParserInterface;
use SMTP2GOWPPlugin\Dotenv\Repository\Adapter\ArrayAdapter;
use SMTP2GOWPPlugin\Dotenv\Repository\Adapter\PutenvAdapter;
use SMTP2GOWPPlugin\Dotenv\Repository\RepositoryBuilder;
use SMTP2GOWPPlugin\Dotenv\Repository\RepositoryInterface;
use SMTP2GOWPPlugin\Dotenv\Store\StoreBuilder;
use SMTP2GOWPPlugin\Dotenv\Store\StoreInterface;
use SMTP2GOWPPlugin\Dotenv\Store\StringStore;
class Dotenv
{
    /**
     * The store instance.
